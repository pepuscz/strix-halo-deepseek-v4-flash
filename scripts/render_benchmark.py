...
def render(data: dict) -> str:
    ...
    lines = [
        ...
        '  <desc id="description">Input-processing and generation throughput for Strix Halo llama.cpp Vulkan IQ3_XXS and the Lucebox ROCm ROCmFPX leading alternative using the same cold five-key retrieval workload. The main horizontal segment is linear from zero through 262,144 tokens; the 491,520-token Vulkan measurement is isolated after an explicit axis break.</desc>',
        "  <style>",
        ...
        "    .reference-mark { fill: none; stroke: #bf3989; stroke-width: 3; }",
        ...
        "      .default-mark { fill: #58a6ff; } .reference-mark { stroke: #db61a2; }",
