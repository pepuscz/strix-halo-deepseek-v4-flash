...
|---|---|---|
| Runtime | Unmodified `strix-halo-llamacpp` v0.6.6 portable release, commit `7b6c61330edf370659f531932e0b91aca67ba055` | Lucebox commit `90f85fa401c6a3c61d9e4d0e2da7fc48a5e8915e` plus [11 patches](#lucebox-source-modifications) |
...
in v0.6.6. Ansible supplies the pinned Vulkan loader, model files, environment,
...
package limits, 2.0 GHz minimum CPU frequency, cgroup memory limits, disabled
swap, and maximum AXB35 cooling while active.
